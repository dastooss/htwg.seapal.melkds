...
<body class="tripinfo">
	...
	<table class="tripinfo_table" border="0">
		...
		<tr>
			...
			<td>
				<label for="crew">Crew </label><textarea id="crew" name="crew" rows="3" style="width: 200px; height: 50px"  onkeyup="isText(this.value, this.id, 0, true)" ></textarea>
			</td>
			<td>
				<table border="0">
